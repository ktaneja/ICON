...
Non-compliance to such constraints will often result in faulty applications that are unreliable. % and may even result in financial losses.
...
However, the effectiveness of such an approach is limited by the quality of the keywords used.
...
\begin{itemize}
	\item A ML- and NLP-based approach that effectively infers formal temporal constraints of method invocations. 
