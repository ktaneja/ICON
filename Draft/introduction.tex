...
1) ``\textit{Use this call to complete a payment.}'' from \CodeIn{execute payment} method.
2) ``\textit{Use this call to refund a completed payment.}'' from \CodeIn{refund sale} method.
...
In summary, the \tool\ approach leverages natural language description of API's to infer temporal constraints of method invocations.
