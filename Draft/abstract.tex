...
On the other hand, automatically inferring temporal constraints from API documents faces is challenging.
...
To address the preceding challenge, we propose an natural-language-processing-based approach \tool,
...
Our evaluation results are promising. In particular, \tool\ achieves an average of 65\% precision and 72\% recall
