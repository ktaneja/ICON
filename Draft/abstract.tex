...
\textbf{Background}: Temporal constraints of an Application Programming
Interface (API) are the allowed sequences of invocations of
...
constraints from commonly used package \CodeIn{java.io} in the
JDK API and from the \amazonAPI. Our results show
that \tool\ effectively identifies constraint sentences (from over
...
the inferred temporal constraints to effectively assist assist in development
