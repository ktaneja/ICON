...
public class ICONEval 
{
	...
	public static void main(String[] args) throws Exception {
		ICONEval eval = new ICONEval();
		String classStr,senStr;
		while(true)
		{
			classStr = ConsoleUtil.readConsole("Class Name : ");
			senStr = ConsoleUtil.readConsole("Sentnce : ");
			System.out.println(eval.test(classStr, senStr));
			
		}
			//System.out.println(eval.test("Pipedriter", "if the pipe is brokenmm , connect unconnected , closed, or if an i/o error occurs."));
	}
}
